#!/usr/bin/env node
/**
 * One-time OAuth2 setup for withradical@gmail.com Google Drive access.
 * Run this once: node google-oauth-setup-withradical.js
 * It will open a browser window — log in as withradical@gmail.com — and saves a token.
 */
...
const CLIENT_SECRET_PATH = path.join(__dirname, '..', 'Google keys', 'client_secret_118415531163-ejulfjfg09hmeoin9lhss7r998a64con.apps.googleusercontent.com.json');
const TOKEN_PATH = path.join(__dirname, '..', 'Google keys', 'withradical-oauth-token.json');
...
console.log('\n=== Radical Life OS - Google Drive OAuth Setup ===\n');
console.log('Opening browser to authorise withradical@gmail.com access...');
